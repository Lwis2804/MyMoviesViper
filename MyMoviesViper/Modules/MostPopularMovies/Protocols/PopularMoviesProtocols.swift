...
// MARK: VIEW -> PRESENTER
protocol PopularMovies_ViewToPresenterProtocol: AnyObject {
	var view: PopularMovies_PresenterToViewProtocol? { get set }
	var interactor: PopularMovies_PresenterToInteractorProtocol? { get set }
	var router: PopularMovies_PresenterToRouterProtocol? { get set }
}
...
protocol PopularMovies_PresenterToInteractorProtocol: AnyObject {
    var presenter: PopularMovies_InteractorToPresenterProtocol? { get set }
}
...
protocol PopularMovies_InteractorToPresenterProtocol: AnyObject {
}
...
// MARK: PRESENTER -> VIEW
protocol PopularMovies_PresenterToViewProtocol: AnyObject {
    var presenter: PopularMovies_ViewToPresenterProtocol? { get set }
}
...
protocol PopularMovies_PresenterToRouterProtocol: AnyObject {
}
